...
showLocation.prototype = {
    ...
    mouseMove: function () {
        ...
        viewer.screenSpaceEventHandler.setInputAction(function onMouseMove(movement) {
                ...
                try {
                    _this.coordinatesDiv.innerHTML = "<span id='cd_label' style='font-size:13px;text-align:center;font-family:微软雅黑;color:#edffff;'>视角高度:" + cameraHeight + "米&nbsp;&nbsp;&nbsp;&nbsp;模型高度:" + MouseHeight.toFixed(2) + "米&nbsp;&nbsp;&nbsp;&nbsp;经度：" + lon.toFixed(6) + "&nbsp;&nbsp;纬度：" + lat.toFixed(6) + "</span>";
                } catch (e) {
